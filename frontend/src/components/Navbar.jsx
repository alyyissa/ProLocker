...
const Navbar = () => {
  return (
    <div className='w-full px-3 sm:px-4 md:px-11 lg:px-13 xl:px-12 2xl:px-16 bg-transparent hover:bg-cocoprimary fixed top-0 py-8'>
        <div className='flex flex-row items-center justify-between'>
          <img src="" alt="" />
          <div className="relative text-gray-600">
            <input type="search" name="serch" placeholder="Search" className="pl-7 h-[45px] w-[440px] py-5 rounded-full text-md focus:outline-none bg-gray-200"/>
