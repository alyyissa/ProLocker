...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`w-full px-3 sm:px-4 md:px-11 lg:px-13 xl:px-12 2xl:px-16 bg-transparent hover:bg-cocoprimary fixed top-0 py-5 md:py-8 z-60
        ${open ? "bg-background" : "bg-transparent"}`}>
          <div className='flex flex-row items-center justify-between'>
            ...
            <div className='flex flex-row items-center gap-5'>
              <Link className=' md:block hidden'><i className="fa-solid fa-user md:text-background text-cocoprimary fa-lg"></i></Link>
